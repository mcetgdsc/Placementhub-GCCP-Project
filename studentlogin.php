...
<body>
    ...
    <section class="background-radial-gradient overflow-hidden">
        ...
        <div class="box">
            <div class="table1">
                <form action="studentlogin.php" class="" method="post">
                        ...
                        <div class="row gx-lg-5 align-items-center mb-5">
                            <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
                                ...
                                <p class="mb-5 opacity-70" style="color: hsl(218, 81%, 85%)">
                                    ...
                                    companies looking to hire.<br>Our mission is to help you take the first steps
                                    towards your career by providing access to exciting internship and placement
                                    opportunities.
                                </p>
                            </div>
